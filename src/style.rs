...
pub const F_DISPLAY: u64 = 1 << 0;
pub const F_BOX_SIZING: u64 = 1 << 1;
pub const F_OVERFLOW_X: u64 = 1 << 2;
pub const F_OVERFLOW_Y: u64 = 1 << 3;
pub const F_SCROLLBAR_WIDTH: u64 = 1 << 4;
pub const F_POSITION: u64 = 1 << 5;
pub const F_INSET_LEFT: u64 = 1 << 6;
pub const F_INSET_RIGHT: u64 = 1 << 7;
pub const F_INSET_TOP: u64 = 1 << 8;
pub const F_INSET_BOTTOM: u64 = 1 << 9;
pub const F_SIZE_WIDTH: u64 = 1 << 10;
pub const F_SIZE_HEIGHT: u64 = 1 << 11;
pub const F_MIN_SIZE_WIDTH: u64 = 1 << 12;
pub const F_MIN_SIZE_HEIGHT: u64 = 1 << 13;
pub const F_MAX_SIZE_WIDTH: u64 = 1 << 14;
pub const F_MAX_SIZE_HEIGHT: u64 = 1 << 15;
pub const F_ASPECT_RATIO: u64 = 1 << 16;
pub const F_MARGIN_LEFT: u64 = 1 << 17;
pub const F_MARGIN_RIGHT: u64 = 1 << 18;
pub const F_MARGIN_TOP: u64 = 1 << 19;
pub const F_MARGIN_BOTTOM: u64 = 1 << 20;
pub const F_PADDING_LEFT: u64 = 1 << 21;
pub const F_PADDING_RIGHT: u64 = 1 << 22;
pub const F_PADDING_TOP: u64 = 1 << 23;
pub const F_PADDING_BOTTOM: u64 = 1 << 24;
pub const F_BORDER_LEFT: u64 = 1 << 25;
pub const F_BORDER_RIGHT: u64 = 1 << 26;
pub const F_BORDER_TOP: u64 = 1 << 27;
pub const F_BORDER_BOTTOM: u64 = 1 << 28;
pub const F_ALIGN_ITEMS: u64 = 1 << 29;
pub const F_ALIGN_SELF: u64 = 1 << 30;
pub const F_JUSTIFY_ITEMS: u64 = 1 << 31;
pub const F_JUSTIFY_SELF: u64 = 1 << 32;
pub const F_ALIGN_CONTENT: u64 = 1 << 33;
pub const F_JUSTIFY_CONTENT: u64 = 1 << 34;
pub const F_GAP_WIDTH: u64 = 1 << 35;
pub const F_GAP_HEIGHT: u64 = 1 << 36;
pub const F_TEXT_ALIGN: u64 = 1 << 37;
pub const F_FLEX_DIRECTION: u64 = 1 << 38;
pub const F_FLEX_WRAP: u64 = 1 << 39;
pub const F_FLEX_BASIS: u64 = 1 << 40;
pub const F_FLEX_GROW: u64 = 1 << 41;
pub const F_FLEX_SHRINK: u64 = 1 << 42;
pub const F_GRID_TEMPLATE_ROWS: u64 = 1 << 43;
pub const F_GRID_TEMPLATE_COLUMNS: u64 = 1 << 44;
pub const F_GRID_AUTO_ROWS: u64 = 1 << 45;
pub const F_GRID_AUTO_COLUMNS: u64 = 1 << 46;
pub const F_GRID_AUTO_FLOW: u64 = 1 << 47;
pub const F_GRID_ROW: u64 = 1 << 48;
pub const F_GRID_COLUMN: u64 = 1 << 49;
pub const F_ALL: u64 = u64::MAX;
...
impl Style {
    ...
    /// Create a Style directly from a taffy::Style with the given set_fields bitmask.
    ///
    /// Intended for benchmarking; not exposed to Python.
    pub fn from_taffy_with_mask(inner: taffy::Style, set_fields: u64) -> Self {
        Self { inner, set_fields }
    }

    /// Merge `other` into `self`: fields explicitly set in `other` override
    /// those in `self`. Returns a new Style.
